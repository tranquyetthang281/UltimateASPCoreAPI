...
namespace Service
{
    internal sealed class EmployeeService : IEmployeeService
    {
        ...
        public async Task<(LinkResponse<LinkedEmployee, EmployeeDto> linkResponse, MetaData metaData)> GetEmployeesAsync
            (Guid companyId, EmployeeLinkParameters linkParameters, bool trackChanges)
        {
            ...
            var links = _employeeLinks.TryGenerateLinks(employeesDto, companyId, linkParameters.Context);
